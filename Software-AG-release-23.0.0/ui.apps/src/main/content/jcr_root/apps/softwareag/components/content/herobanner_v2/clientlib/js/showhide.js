...
(function(document, $) {
	...
	function showHide(component, element) {
		...
		var $target = $(target);
		var targetprimarypromo = $(document).find("[name*='./enableprimarypromo']").data("cqDialogCheckboxShowhideTarget");
		var targetsecondarypromo = $(document).find("[name*='./enablesecondarypromo']").data("cqDialogCheckboxShowhideTarget");
		...
		if (target) {
			$target.addClass("hide");
                ...
                {
                    $(".image-video-tab-showhide-target").addClass("hide");
                }
			if (component.checked) {
