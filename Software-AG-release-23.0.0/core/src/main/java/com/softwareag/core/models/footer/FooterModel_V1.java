...
public class FooterModel_V1 extends AbstractConfigurationComponent {
	
	private static final String FOOTER_CONFIG_RESOURCE_TYPE = "softwareag/components/configs/footer-v1";
	//public static final String  FOOTER_RESOURCE_TYPE = "softwareag/components/content/footer-v1";
