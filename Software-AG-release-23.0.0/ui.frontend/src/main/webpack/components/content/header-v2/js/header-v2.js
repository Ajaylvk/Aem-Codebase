...
/* eslint-disable */
class HeaderV2 extends AEM.Component {
  constructor(element) {
    super(element);
    ...
    this.selectors = {
      ...
      parentDiv: ".header-v2-parent",
      burgerMenuButtonV1: ".headerV2__icons-menu",
      headerIconFirstV1: ".headerV2__icons-first",
      headerIconSecondV1: ".headerV2__icons-second",
      regionChangerText: "region-changer-text",
      regionChangerSpacing: "regionChanger-spacing_mobile-view",
      nav: ".headerV2__nav",
    };
    this.states = {
      headerV2Sticky: "headerV2--sticky",
      navigationbarActive: "navigationV1_Activate",
      active: "region-v1__holder--active",
      navActive: "headerV2__nav--active",
    };
  }
  ...
  init() {
    ...
    if (
      $("#header-v2-parent-Id").hasClass(
        "input__colorselect-text-background-text-component-color3"
      )
    ) {
      $(".header-v2").addClass("header-dark-mode");
    }
  ...
  _attachHandlersV1() {
    ...
    $(".headerV2__icons-menu-close").on("click", () =>
      this._handleBurgerMenuClose()
    );
    $(".headerV2__icons-menu-open").on("click", () =>
      this._handleBurgerMenuClickV1()
    );
    $(".headerV2__icons-menu-regionChanger").on("click", () =>
      this._closeRegion()
    );
  }
  ...
  showRegionList2() {
    ...
    $(".headerV2__icons-menu-close").css("display", "none");
    $(".headerV2__icons-menu-regionChanger").addClass(
  ...
  _closeRegion() {
    $(".headerV2__icons-menu-close").css("display", "block");
  ...
  _handleBurgerMenuClose() {
    ...
    $(".headerV2__icons-menu-open")[0].style.display = "block";
    $(".headerV2__icons-menu-close")[0].style.display = "none";
  ...
  _toggleStickyV1() {
    $(this.element)
      .parent()
      .toggleClass(this.states.headerV2Sticky, window.scrollY !== 0);
  }
  ...
  _handleBurgerMenuClickV1() {
    ...
    $(".headerV2__icons-menu-open")[0].style.display = "none";
...
/* eslint-enable */
AEM.registerComponent('.header-v2', HeaderV2);
