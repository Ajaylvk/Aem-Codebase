...
@Component(service = Servlet.class, property = {
		...
		"sling.servlet.resourceTypes=" + RLIndustryTagDataSourceServlet.RESOURCE_TYPE, "sling.servlet.methods=GET",
		"sling.servlet.extensions=html" })
public class RLIndustryTagDataSourceServlet extends SlingSafeMethodsServlet {

	public static final String RESOURCE_TYPE = "softwareag/datasources/industrytags";
	private static final Logger LOG = LoggerFactory.getLogger(RLIndustryTagDataSourceServlet.class);
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
		...
		Resource contentTagResource = tagResource.getChild("industry_v1");
