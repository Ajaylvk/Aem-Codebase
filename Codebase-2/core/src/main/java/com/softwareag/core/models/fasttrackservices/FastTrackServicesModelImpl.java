...
@Model(adaptables = { SlingHttpServletRequest.class },
        adapters = { FastTrackServicesModel.class, ComponentExporter.class },
        resourceType = { FastTrackServicesModelImpl.RESOURCE_TYPE },
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
@Exporter(name = ExporterConstants.SLING_MODEL_EXPORTER_NAME,
        extensions = ExporterConstants.SLING_MODEL_EXTENSION)
public class FastTrackServicesModelImpl implements FastTrackServicesModel{

    public static final String RESOURCE_TYPE = "softwareag/components/content/fasttrackservicesfilter";

    private static final Logger LOG = LoggerFactory.getLogger(FastTrackServicesModelImpl.class);
...
/*        if(ArrayUtils.isNotEmpty(filter3tags)) {
            ...
            filter3TagMap = sortByKeyCreditRange(filter3TagMap);
        }*/
    ...
    public  Map<String, String> sortByKeyCreditRange(Map<String, String> hm){
        List<Map.Entry<String, String> > list = new LinkedList<Map.Entry<String, String> >(hm.entrySet());
        Collections.sort(list, Comparator.comparing(i -> Integer.parseInt(i.getKey().split("-")[0])));
        HashMap<String, String> temp
                = new LinkedHashMap<String, String>();
        for (Map.Entry<String, String> aa : list) {
            temp.put(aa.getKey(), aa.getValue());
