...
@Component(service = Servlet.class, property = {
		...
		"sling.servlet.resourceTypes=" + RLContentTagDataSourceServlet.RESOURCE_TYPE, "sling.servlet.methods=GET",
		"sling.servlet.extensions=html" })
public class RLContentTagDataSourceServlet extends SlingSafeMethodsServlet {

	public static final String RESOURCE_TYPE = "softwareag/datasources/contenttags";
	private static final Logger LOG = LoggerFactory.getLogger(RLContentTagDataSourceServlet.class);
	...
	protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response) {
		...
		Resource contentTagResource = tagResource.getChild("content-type");
		...
		while (childTags.hasNext()) {
			...
			Map<Locale, String> localizedTitles = tag.getLocalizedTitles();
			for (Entry<Locale, String> entry : localizedTitles.entrySet()) {
				System.out.println("Locale = " + entry.getKey() + ", Tag Title = " + entry.getValue());
				System.out.println("Localized Tag Name: " + tag.getLocalizedTitle(entry.getKey()));
			}
		}
