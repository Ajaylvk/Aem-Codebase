...
@Component(
        ...
        property = {
                Constants.SERVICE_DESCRIPTION + "= Free Trail Servlet",
                SLING_SERVLET_METHODS + "=" + HttpConstants.METHOD_POST,
                SLING_SERVLET_RESOURCE_TYPES + "=" + FreeTrailServlet.RESOURCE_TYPE,
                SLING_SERVLET_EXTENSIONS + "=" + FreeTrailServlet.EXTENSION_JSON,
                SLING_SERVLET_SELECTORS + "=" + "freetraildata"
        }
)
public class FreeTrailServlet extends SlingAllMethodsServlet {
    private static final Logger LOG = LoggerFactory.getLogger(FreeTrailServlet.class);
    protected static final String EXTENSION_JSON = "json";
    public static final String SELECTOR = "freetraildata";
    ...
    protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response)
        ...
        rootObj = filterService.getResponse(requestObj, request, FreeTrailServlet.SELECTOR, dropDownOrder);
